...
type Op = XX |NOP | TRAP | RET | RETF | IRET | HALT | WAIT | WAITI | DIV16 | CALLN | CALL | CALLF | PUSH | SWAP | SHL | SHR | SHLA | 
            SHRA | SHL0 | SHR0 | SHRS | POP | SUBTEST | ANDTEST | TEST | GO | GON | GOF | IFC1 | IFC0 | IFZ1 | IFZ0 | IFH1 | IFH0 | 
            IFV1 | IFN1 | IFN0 | IFV0 | IFI1 | IFI0 | IFINT1 | IFINT0 | IFT | IFF | IFSGE | IFSG | IFSLE | IFSL | IFUGE | IFUG | 
            IFULE | IFUL | IFBT | IFBF | IFBTF | IFT0 | IFT1 | INC | DEC | NEG | NOT | ADD | ADC | SUB | SBC | MUL | DIV | AND | 
            OR | XOR | CHANGE | TO | BREAK | SKIP | INLINE | NOTYET
